...
//		result += LanguageService.get("1. 언어 설정 2. 난이도 설정 3. 만든 사람들 4. 디스코드 5. 개발자에게 기부하기 6. 메인 메뉴");
		...
		result += mainView.getSeperator();
		result += mainView.addMenuMarginCenter("언어 설정", "난이도 설정", "만든 사람들", "디스코드", "개발자에게 기부하기", "메인 메뉴");
	...
	public void setLang() {
		...
		result += mainView.getSeperator();
		result += mainView.addMenuMarginCenter("한국어", "English", "日本語", "돌아가기");
		result += mainView.getSeperatorThin();
...
//		result += "\r\n";
	...
	public void setDiff() {
		...
		result += mainView.getSeperator();
		result += mainView.addMenuMarginCenter("쉽게", "보통", "어렵게", "돌아가기");
		result += mainView.getSeperatorThin();
